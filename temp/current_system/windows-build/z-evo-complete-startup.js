...
// 🧬 Z-EVO Complete System Startup Script
// This script starts all required services in proper sequence
    ...
    const frontendProcess = spawn('npm', ['run', 'dev'], {
        ...
        env: {
            ...
            CUSTOM_HEADERS: JSON.stringify({
                'X-Powered-By': 'Z-Evo-by-SahonSrabon',
...
// Start MCP Server (Integrated version)
async function startMCPServer() {
    console.log('🧬 Starting Z-Evo MCP Server...');
    
    const mcpProcess = spawn('node', ['/home/sahon/admin/packages/zombiecoder-mcp-server/src/index.js'], {
        stdio: 'pipe',
        env: {
            ...process.env,
            NODE_ENV: 'production',
    ...
    mcpProcess.stdout.on('data', (data) => {
        ...
        if (output.includes('ready') || output.includes('listening')) {
            console.log('✅ Z-Evo MCP Server ready!');
        }
...
async function startWebSocketMCPServer() {
    ...
    const wsProcess = spawn('node', ['/home/sahon/admin/packages/mcp-server/websocket-mcp-server.js'], {
        stdio: 'pipe',
        env: {
            ...process.env,
            CUSTOM_HEADERS: JSON.stringify({
...
function displayStatus() {
    console.log('\n' + '='.repeat(60));
    console.log('🧬 Z-EVO SYSTEM STATUS');
...
async function start() {
    console.log('🧬 Z-EVO COMPLETE SYSTEM STARTUP');
    console.log('=====================================');
    ...
    try {
        ...
        if (servicesReady) {
            ...
            console.log('Your Z-Evo system is now fully operational.');
        } else {
