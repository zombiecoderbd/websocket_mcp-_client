-- UAS Admin System - Dynamic Column Enhancement (Fixed Version)
-- Version: 2.1
...
-- =====================================================
ALTER TABLE ai_providers ADD COLUMN display_name VARCHAR(150) AFTER name;
ALTER TABLE ai_providers ADD COLUMN sort_order INT DEFAULT 0 AFTER is_active;
...
ALTER TABLE ai_providers ADD COLUMN ui_config JSON AFTER tags;

-- =====================================================
-- ADD DYNAMIC COLUMNS TO SERVERS TABLE
-- =====================================================
ALTER TABLE servers ADD COLUMN display_name VARCHAR(150) AFTER name;
ALTER TABLE servers ADD COLUMN sort_order INT DEFAULT 0 AFTER status;
...
ALTER TABLE servers ADD COLUMN ui_config JSON AFTER tags;

-- =====================================================
-- ADD DYNAMIC COLUMNS TO AI_MODELS TABLE
-- =====================================================
ALTER TABLE ai_models ADD COLUMN display_name VARCHAR(150) AFTER model_name;
ALTER TABLE ai_models ADD COLUMN sort_order INT DEFAULT 0 AFTER status;
...
ALTER TABLE ai_models ADD COLUMN ui_config JSON AFTER tags;

-- =====================================================
-- ADD DYNAMIC COLUMNS TO AGENTS TABLE
-- =====================================================
ALTER TABLE agents ADD COLUMN display_name VARCHAR(150) AFTER name;
ALTER TABLE agents ADD COLUMN sort_order INT DEFAULT 0 AFTER status;
...
ALTER TABLE agents ADD COLUMN ui_config JSON AFTER tags;
...
-- =====================================================
CREATE INDEX idx_ai_providers_display ON ai_providers(display_name);
CREATE INDEX idx_ai_providers_sort ON ai_providers(sort_order);
CREATE INDEX idx_ai_providers_visible ON ai_providers(is_visible);
CREATE INDEX idx_ai_providers_category ON ai_providers(category);

CREATE INDEX idx_servers_display ON servers(display_name);
CREATE INDEX idx_servers_sort ON servers(sort_order);
CREATE INDEX idx_servers_visible ON servers(is_visible);
CREATE INDEX idx_servers_category ON servers(category);

CREATE INDEX idx_ai_models_display ON ai_models(display_name);
...
CREATE INDEX idx_agents_display ON agents(display_name);
CREATE INDEX idx_agents_sort ON agents(sort_order);
CREATE INDEX idx_agents_visible ON agents(is_visible);
CREATE INDEX idx_agents_category ON agents(category);

CREATE INDEX idx_prompt_templates_display ON prompt_templates(display_name);
CREATE INDEX idx_prompt_templates_sort ON prompt_templates(sort_order);
CREATE INDEX idx_prompt_templates_visible ON prompt_templates(is_visible);
CREATE INDEX idx_prompt_templates_category ON prompt_templates(category);

CREATE INDEX idx_editor_integrations_display ON editor_integrations(display_name);
CREATE INDEX idx_editor_integrations_sort ON editor_integrations(sort_order);
CREATE INDEX idx_editor_integrations_visible ON editor_integrations(is_visible);
CREATE INDEX idx_editor_integrations_category ON editor_integrations(category);
